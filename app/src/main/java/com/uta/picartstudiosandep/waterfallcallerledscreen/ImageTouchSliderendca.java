...
public class ImageTouchSliderendca extends RelativeLayout {
    ...
    public ImageTouchSliderendca(Context context) {
        super(context);
        init(context, null);
    }

    public ImageTouchSliderendca(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ImageTouchSliderendca(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(R.layout.unlock_mainendcall, this, true);

        // Retrieve layout elements
        text_label = (TextView) findViewById(R.id.text_label);
        img_thumb = (ImageView) findViewById(R.id.img_thumb);
        img_thumbright = (ImageView) findViewById(R.id.img_thumbright);
